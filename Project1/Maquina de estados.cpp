/*
	Practica 10 Maquina de estados
	Alcaraz Cárdenas Jorge Alberto
	Fecha  entrega: 21 de Octubre de 2024
*/
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion maquina de estados Jorge Alcaraz", nullptr, nullptr);
